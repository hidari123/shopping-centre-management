<!--
 * @Author: OBKoro1
 * @Date: 2022-04-18 15:57:00
 * @LastEditors: hidari
 * @LastEditTime: 2022-04-18 16:58:35
 * @FilePath: \shopping-centre-management\src\views\home\components\home-product.vue
 * @Description:
 *
...
import { reqFindGoods } from '@/api/home.js'
export default {
  name: 'HomeProduct',
  components: { HomePanel, HomeGoods },
  setup () {
    const { target, res } = useLazyData(reqFindGoods)
    return {
      target, goods: res
    }
  }
