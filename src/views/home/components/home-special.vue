 ...
 * @LastEditors: hidari
 * @LastEditTime: 2022-04-18 17:04:38
 * @FilePath: \shopping-centre-management\src\views\home\components\home-special.vue
 * @Description:
 *
...
import { reqFindSpecial } from '@/api/home.js'
import { useLazyData } from '@/hooks'
export default {
  name: 'HomeSpecial',
  components: { HomePanel },
  setup () {
    const { target, res } = useLazyData(reqFindSpecial)
    return {
      target,
      specialList: res
    }
