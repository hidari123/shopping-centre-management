<!--
 * @Author: hidari
 * @Date: 2022-04-28 14:20:03
 * @LastEditors: hidari
 * @LastEditTime: 2022-04-28 15:39:33
 * @FilePath: \shopping-centre-management\src\views\member\pay\index.vue
 * @Description: 支付页面
 *
    ...
    <div class="container">
      ...
      <div class="pay-type">
        ...
        <div class="item">
          ...
          <a class="btn alipay" :href="payUrl" target="_blank" @click="visibleDialog=true" ></a>
        </div>
        <div class="item">
          <p>支付方式</p>
